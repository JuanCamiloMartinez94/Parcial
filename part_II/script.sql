...
Insert into ANSWERS (ID,NUMBER_OF_QUESTION,ANSWER) values ('3','QUESTION 3','10');
...
--------------------------------------------------------
  ...
  ALTER TABLE "CATEGORIES" ADD CONSTRAINT "CHECK_SEASON" CHECK (season IN('winter','summer','spring','autumn')) ENABLE
...
--------------------------------------------------------
  ...
  ALTER TABLE "PRODUCTS" ADD CONSTRAINT "FK_CATEGORIES_PRODUCTS" FOREIGN KEY ("CATEGORY_ID")
